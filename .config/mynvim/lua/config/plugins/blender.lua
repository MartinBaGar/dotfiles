		...
		require("blender").setup {
			profiles = { --                 Profile[]?            list of blender profiles
				--
				{
					...
					cmd = '/mnt/c/Program Files/Blender Foundation/Blender 4.2/blender.exe', --         string|string[]       command to run Blender
					...
					-- extra_args = {
					-- 	'--python',
					-- 	'/home/mabagar/.local/share/mynvim/lazy/blender.nvim/launcher.py'
					-- } --       string[]?             extra arguments to pass to Blender
