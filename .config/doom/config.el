...
(after! org
  ...
  (defmacro def-python-babel-preset! (name &rest header-args)
    "Register NAME as a Babel language alias for python with default HEADER-ARGS."
    (let* ((name-str (symbol-name name))
      ...
      `(progn
         ...
         (when (fboundp 'org-babel-edit-prep:python)
           (defalias ',edit-prep-sym #'org-babel-edit-prep:python))
  ...
  ;; --- presets, one line of intent each ---
